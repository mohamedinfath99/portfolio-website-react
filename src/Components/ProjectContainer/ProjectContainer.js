...
const ProjectContainer = () => {
  ...
  const clone_works = [

    {
      ...
      desc: "Clone of Facebook with some functionalities like authentication, adding posts, etc.",
...

    {
      img: img8,
      title: "Amazon Clone",
      desc: "Clone of Amazon with some functionalities like authentication, adding items to the cart, etc.",
    ...
    },
    {
      img: img10,
      title: "Hulu Clone",
      desc:  "Clone of Hulu with some functionalities like search movies based on category, etc.",
...

    {
      img: img11,
      title: "Slack Clone",
      desc: "Clone of Slack with some functionalities like create new rooms, chat with the people in the rooms, etc.",
...

    {
      ...
      desc: "Clone of Messenger with some functionalities like chat with everyone, etc.",
...

    {
      img: img13,
      title: "Tinder Clone",
      desc:  "Clone of Tinder with some functionalities like choose or reject different people, etc.",
...

    {
      img: img14,
      title: "Youtube Clone",
      desc: "Clone of Youtube with some functionalities like display random videos, etc.",  
...

    {
      ...
      desc:  "Clone of WhatsApp with some functionalities like create new groups, chat with different people, etc.",
  ...
  return (
    <Element className="projectContainer" id="project">
      <div className='ProjectContainer_pp'>
        <h1><u>Projects</u></h1>
        <br />
        <p> 
          Here are some projects which are changing many people lives and someclone works of large tech tack companies.
        </p>
      </div>
      ...
      <div className="projectContainer__title">
        ...
        <h4 className={choosen ? "projectContainer__title--active" : undefined}  onClick={() => setChoosen(true)} >
          Client Projects
        </h4>

        <h4 className={!choosen ? "projectContainer__title--active" : undefined} onClick={() => setChoosen(false)} >
          Clone Projects
        </h4>
      ...
      {choosen ? (
        <div className="projectContainer__projects">
          {client_projects.map((project, index) => (
            <Project  key={index} img={project.img} desc={project.desc} title={project.title}  link={project.link} /> ))
          }
        </div>
